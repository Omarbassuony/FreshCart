...
export default function ResetPassword() {
    ...
    const loginSchema = yup.object({
        ...
        newPassword: yup.string().required("Password is required").min(6, "Password must be at least 6 characters").max(25, "Password must be less than 25 characters"),
    });
    ...
    return (
        <div className="container flex flex-col items-center justify-center py-24 px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="font-bold text-xl text-green-600 mb-2">Reset Password Now:</h1>
